...
Gilmore, R.O., Diaz, M.T., Wyble, B.A., & Yarkoni, T. (2017). Progress toward openness, transparency, and reproducibility in cognitive neuroscience. *Annals of the New York Academy of Sciences*. [doi: 10.1111/nyas.13325](http://doi.org/10.1111/nyas.13325)
...
## Book chapters, preprints, and technical reports
...
Gilmore, R.O. & Nilsonne, G. (2017, July 30). IRBs and the ethical sharing of research data. Talk given at the Society for Improving Psychological Science meeting. [HTML slides](http://gilmore-lab-github.io/sips-2017-07-30/). [OSF project](http://osf.io/9d5hr).
...
Gilmore, R.O. (2017, January). An -ome of our own: Toward a more reproducible, robust, and insightful science of human behavior. Talk in the Penn State Social Data Analytics (SoDA) 501 Course. [HTML slides](https://rawgit.com/gilmore-lab/soda-2017-01-31/master/soda-2017-01-31.html)
...
Gilmore, R.O. (2016, September). Donald Rumsfeld and the promise of a 'big data' science of human behavior. Talk given at a meeting of the Penn State Stochastic Modeling and Computational Statistics (SMACS) group, Department of Statistics. [HTML slides](https://rawgit.com/gilmore-lab/psu-stats-smacs-2016-talk/master/gilmore-smacs-2016-09-02.html).

Gilmore, R.O., Adolph, K.E., & David Millman. (2016, May). To boldly go where no science... Talk given at the [New York University Reproducibility Symposium](https://reproduciblescience.org/nyu/events/reproducibility-symposium-2016/). [HTML slides](https://rawgit.com/databrary/presentations/master/nyu-data-science-reproducibility-16/be-bold.html#1)
